class Kandi < Formula
  ...
  homepage "https://github.com/KandiForge/kandi-cli-osx"
  url "https://github.com/KandiForge/kandi-cli-osx/releases/download/v1.0.2/kandi-cli-v1.0.2-macos-universal.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      For more information, visit: https://github.com/KandiForge/kandi-cli-osx
    EOS
  end
